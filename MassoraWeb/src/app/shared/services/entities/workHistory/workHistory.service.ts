...
import { WorkHistoryModel } from '../../../models/entities/workhistory.model';

@Injectable({
  providedIn: 'root',
})
export class WorkkHistoryService extends BaseApiRequestService<WorkHistoryModel> {

  constructor(protected override httpClient: HttpClient) {
    super(httpClient);
    // Bu servise özel API endpoint'ini belirtiyoruz.
    this.apiUri = 'workHistory';
  }
   ...
   */
  public getWorkHistoriesPaginated(
    pageNumber: number,
    pageSize: number,
    searchTerm: string
  ...
  public getById(id: number): Observable<WorkHistoryModel> {
