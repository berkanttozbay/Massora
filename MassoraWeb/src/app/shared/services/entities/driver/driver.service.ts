...
import { DriverModel } from '../../../models/entities/driver.model'; // Modelinizin yolu
...
export class DriverService extends BaseApiRequestService<DriverModel> {
   ...
   * @param registrationData Sürücünün profil ve giriş bilgilerini içeren nesne.
   * @returns Oluşturulan DriverModel nesnesini bir Observable olarak döndürür.
   */
  public getDriversPaginated(
    pageNumber: number,
    pageSize: number,
    searchTerm: string
  ...
  public getForDropdown(): Observable<DropdownModel[]> {
    ...
    public getById(id: number): Observable<DriverModel> {
