...
import { FuelHistoryModel } from '../../../models/entities/fuelhistory.model';

@Injectable({
  providedIn: 'root',
})
export class FuelHistoryService extends BaseApiRequestService<FuelHistoryModel> {

  constructor(protected override httpClient: HttpClient) {
    super(httpClient);
    // Bu servise özel API endpoint'ini belirtiyoruz.
    this.apiUri = 'vehicleFuelHistory';
  }
   ...
   */
  public getFuelHistoriesPaginated(
    pageNumber: number,
    pageSize: number,
    searchTerm: string
  ...
  public getById(id: number): Observable<FuelHistoryModel> {
